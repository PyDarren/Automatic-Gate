...
if __name__ == '__main__':
    ...
    train_data = pd.read_csv(data_path+'traindata_18_35.csv')
    test_data = pd.read_csv(data_path+'testdata_18_35.csv')
    ...
    ## save model
    model.save('C:/Users/pc/OneDrive/PLTTECH/Project/01_自动圈门建模/Models/18_35_classfy.h5')
