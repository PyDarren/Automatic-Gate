...
if __name__ == '__main__':
    ...
    train_data = pd.read_csv(data_path+'traindata_26_no26.csv')
    test_data = pd.read_csv(data_path+'testdata_26_no26.csv')
    ...
    ## save model
    model.save('C:/Users/pc/OneDrive/PLTTECH/Project/01_自动圈门建模/Models/26_no26_classfy.h5')
